...
{
    public class UsuariosEntityController : Controller
    {
        ...
        // GET: UsuariosEntity/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: UsuariosEntity/Create
